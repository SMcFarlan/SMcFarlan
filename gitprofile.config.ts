...
const CONFIG = {
  github: {
    username: 'SMcFarlan', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  seo: {
    title: 'Portfolio of Sean McFarlan',
    description: '',
    imageURL: '',
  },
  social: {
    ...
    skype: '',
    telegram: '',
    website: 'https://smcfarlan.github.io',
    phone: '',
    email: 'smcfarlan@csustan.edu',
  },
  resume: {
    fileUrl:
